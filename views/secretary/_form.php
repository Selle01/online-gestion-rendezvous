...
<div class="collapse  w-100" id="collapseExample">
    <div class="card card-primary w-100">
        <form class="needs-validation secretary_form" novalidate="" make="new">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <?= $form->input('text', 'required', 'dateNais', 'datepicker_dateNais_secretary', 'Date de Naissance', 'off') ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <?= $form->input('text', 'required', 'created_at', 'datepicker_created_at_secretary', 'Date de ceration', 'off') ?>
                    </div>
                </div>
            </div>
            <div class="card-footer text-right">
                <button type="submit" class="btn btn-primary secretary_submit">Créer</button>
                <a type="button" class="btn btn-light secretary_reset">Annuler</a>
