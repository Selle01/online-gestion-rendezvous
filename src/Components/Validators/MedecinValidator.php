...
class MedecinValidator extends CommonValidator
{

    public function __construct(array $data, UserDao $itemDao, ?int $itemID = null, $genres, $specialties)
    {
        parent::__construct($data);
        $this->validator->rule('required', [
            'role_id', 'matricule', 'firstName', 'lastName', 'genre', 'login',
            // 'password', 
            'CNI', 'email', 'tel', 'specialty_id'
        ]);
